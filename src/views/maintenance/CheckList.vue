        ...
        <div class="dispatch-table">
          <b-card>
            ...
            <div class="newButton">
              <b-button
                variant="primary"
                @click="$router.push('/Maintenance/636917825011241771/new/checklist')"
              >
            ...
            >
              <template slot="action_button" slot-scope="data">
                <router-link
                  ...
                  :to="'/Maintenance/636917825011241771/modify/checklist/' + data.item.indicatorId"
                >
          ...
          <b-list-group v-for="(item,index) in items" :key="`dynlist-${index}`" class="shadow">
            <b-list-group-item class="flex-column align-items-start">
              <div class="list-field">
                <span class="mb-1 dis">Short Name:{{item.shortname}}</span>
              </div>

              <div class="list-field">
                <span class="mb-1 dis">Description:{{ item.description}}</span>
              </div>
              <div class="list-field">
                <span class="mb-1 dis">
                  Attach Required:
                  <i
                    :class="item.attachrequired == true ?  'activeStatus icon-check active_icon' : 'inactiveStatus icon-close inactive_icon'"
                  ></i>
                </span>
              </div>
              <div class="list-field">
              ...
              <div class="row">
                <div class="col">
                  <router-link
                    tag="button"
                    :to="'/Maintenance/636917825011241771/modify/checklist/' + item.indicatorId"
