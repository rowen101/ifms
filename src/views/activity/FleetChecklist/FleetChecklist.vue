          ...
          <b-card>
            ...
            >
              <template slot="action_button" slot-scope="data">
                <router-link
                  tag="button"
                  :to="'/Activity/636892437634740910/setup/fleet-checklist/' + data.item.fleetregistryId"
            ...
            <b-list-group-item class="flex-column align-items-start">
              ...
              <div class="row">
                <div class="col">
                  <router-link
                    tag="button"
                    :to="'/Activity/636892437634740910/setup/fleet-checklist/' + item.fleetregistryId"
...
export default {
  ...
  methods: {
    ...
    onexport: function() {
      JSONToCSVConvertor(this.items, "Fleet Checklist", true);
    },
