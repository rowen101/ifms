<template>
  <div class="animated fadeIn">
    <div class="dispatch-list row">
      <router-link :to="'/Activity/636859985185080849'" tag="button" class="btn btn-none btn-sm">
      ...
      >
        <div>
          ...
          >
            ...
            >
              <b-col mb="1">
                <b-button variant="success" block @click="onSelecteItemToFinish(item)">Finished</b-button>
              </b-col>
            </b-row>
            <br />
  ...
  methods: {
    initData: function() {
      ...
      if (self.$route.params.id !== undefined) {
        api.instance
          .get(
            "wfms/get-transregistry-list?fleetregestryId=" +
          ...
          .then(resp => {
            self.transActivityList = resp.data.translist;
            self.depart = resp.data.depart;
    ...
    onSelecteItemToStart: function(param) {
      ...
      this.selectedItemLabel = this.selectedItem.transDescription;
